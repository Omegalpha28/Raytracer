...
namespace Math {
    ...
    public:
        ...
        // Opérateurs binaires (retournent un nouveau vecteur)
        ...
        // Opérateurs composés (modifient l’objet courant)
